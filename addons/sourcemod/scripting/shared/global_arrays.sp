...
float Mana_Regen_Delay_ManaFlower_Terrarium[MAXPLAYERS];
bool b_Hero_Of_Concord[MAXENTITIES];
bool b_Hero_Of_Concord_LastMan[MAXPLAYERS];
bool b_Hero_Of_Concord_True;
int i_Hero_Of_Concord[MAXPLAYERS]={0, ...};
bool b_Hero_Of_Concord_Deadman;
bool b_Box_Office[MAXPLAYERS];
bool b_Sandvich_SafeHouse[MAXPLAYERS];
bool b_Sandvich_Crits[MAXPLAYERS];
int i_Sandvich_Crits_AttackCount[MAXPLAYERS];
int i_Sandvich_Crits_DamageCount[MAXPLAYERS];
bool b_DeathfromAbove[MAXPLAYERS];
bool b_POWERHEAL[MAXPLAYERS]={false, ...};
bool b_Chaos_Coil[MAXPLAYERS];
int i_Chaos_Coil_Speed[MAXPLAYERS];
float f_Chaos_Coil[MAXPLAYERS];
int i_Chaos_Coil[MAXPLAYERS]={0, ...};
bool b_Force_Shield_Generator[MAXPLAYERS];
bool b_Shotgun_Slug_Ammo[MAXPLAYERS];
float f_Nailgun_Shotgun_Slug_Ammo[MAXPLAYERS];
bool b_DrinkRND_BuildingCD_Buff[MAXPLAYERS];
bool b_Shotgun_Dragonr_Beath_Ammo[MAXPLAYERS];
bool b_Explosive_Structures[MAXPLAYERS];
...
bool b_MarketGardener_Uniform[MAXPLAYERS];
bool b_ManaFlower_Terrarium[MAXPLAYERS];
bool b_Golden_Crown[MAXENTITIES];
bool b_Mana_Infusion_Ammunition[MAXPLAYERS];
